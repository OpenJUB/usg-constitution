...
\end{enumerate}
\add[S]{Only in exceptional cases, as decided by the \hyperref[USGParliamentDef]{USG Parliament}, one student is allowed to be the Undergraduate Student Representatives (excluding substitutes) of more than one official Committees of Jacobs University with student representatives (USR).}
