...
The Undergraduate Parliament shall be composed of \add[S]{ten (10) elected Members of Parliament:}\remove[S]{the Elected Offices:  
...
\item in first week of December for: \remove[S]{Vice-President, }Focus Area representatives, Treasurer\add[S]{, 5 Members of Parliament } (and for any open position),
\item in first week of May for: \remove[S]{President, }College representatives\add[S]{, 5 Members of Parliament} (and for any open position).
\end{enumerate}
...
\protect\begin{parenum}
	\item Firstly, the candidate with most votes from within each committee (if any) becomes a new Member of Parliament
	\item All remaining positions are filled by candidates from any committee according to the number of votes they received.
\end{parenum}
}
...
\label{PresiElection}
In the beginning of each Fall semester, the newly elected Parliament shall elect a President and in the beginning of each Spring semester they shall elect a Vice-President amongst the Members of Parliament. Both President and Vice-President can be recalled any time with a 2/3 majority in the Parliament. In this case, a new President must be elected immediately.
}
