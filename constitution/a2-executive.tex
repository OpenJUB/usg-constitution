...
\item \hyperref[AACdef]{Academic Affairs}\remove[RS]{, chaired by a \protect\hyperref[FARepDef]{Focus Area Representative}},
\item \hyperref[CACdef]{Campus Affairs}\remove[RS]{, chaired by a \protect\hyperref[CRepDef]{Residential College Representative}},
\item \hyperref[Financesdef]{Financial Affairs}\remove[S]{, chaired by the \protect\hyperref[TreasurerDef]{Treasurer}},
\add[S]{\protect\item \hyperref[IACdef]{International Affairs},}
\item \hyperref[suppstrucdef]{Support structures}: Secretaries, IT Department, PR\add[S]{ Department}.
\end{enumerate}
\annote[Colin]{The chairs for the \protect\change[S]{\protect\hyperref[AACdef]{Academic} and \protect\hyperref[CACdef]{Campus Affairs Committee}}{Exectutive Committees} are \add[S]{elected within their committee after each USG election (either in May or December) and }\protect\change[S]{elected}{approved} with a simple majority within the \protect\hyperref[USGParliamentDef]{USG Parliament}}{Maybe just strike this?}.
...
\note[N]{The moderation of Parliament meetings is regulated in Section \protect\ref{ParlamentChair}}\protect\item} inform the \hyperref[studentbody]{USB} and the USG about matters falling within their competence, especially when requested by these bodies,
\item be \remove[S]{the main }responsible for the USG's actions and oversee its structure and inner workings,
...
\label{IACdef}
\add[S]{The International Affairs Committee shall be responsible for all USG matters pertaining to cooperations with other universities and their student bodies. }
...
\item organize \add[S]{and follow up on }tasks, check for completion;
\add[S]{\protect\item organize and update the USG documentation, ensuring full transparency of the USG's actions}
\end{enumerate}
...
\item Public Relations \change[S]{Manager}{Department} shall:
\begin{enumerate}
...
\end{enumerate}
\end{parenum}
These roles shall be positions any student can apply for, \change[S]{and the USG shall elect or choose a candidate, i.e. this decision is to be carried out by USG members only}{then the candidate is selected within the USG Parliament}.