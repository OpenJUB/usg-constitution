...
\item \hyperref[AACdef]{Academic Affairs}\remove[S]{, chaired by a \protect\hyperref[FARepDef]{Focus Area Representative}},
\item \hyperref[CACdef]{Campus Affairs}\remove[S]{, chaired by a \protect\hyperref[CRepDef]{Residential College Representative},}
...
\end{enumerate}
The chairs for the \hyperref[AACdef]{Academic}\remove[S]{ and}\add[S]{, } \hyperref[CACdef]{Campus Affairs Committees}\add[S]{and }\hyperref[IACdef]{\add[S]{International Affairs Committee}} are elected with a simple majority within the \hyperref[USGParliamentDef]{USG Parliament}.
