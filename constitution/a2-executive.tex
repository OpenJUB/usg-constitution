...
\end{enumerate}
The chairs for the \change[S]{\protect\hyperref[AACdef]{Academic} and \protect\hyperref[CACdef]{Campus Affairs Committee}}{Exectutive Committees} are \change[S]{elected}{approved} with a simple majority within the \hyperref[USGParliamentDef]{USG Parliament}.
