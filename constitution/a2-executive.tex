...
\item \hyperref[AACdef]{Academic Affairs}\add[S]{,}\remove[S]{, chaired by a \protect\hyperref[FARepDef]{Focus Area Representative}},
\item \hyperref[CACdef]{Campus Affairs}\add[S]{,}\remove[S]{, chaired by a \protect\hyperref[CRepDef]{Residential College Representative},}
\item \hyperref[Financesdef]{Financial Affairs}\add[S]{,}\remove[S]{, chaired by the \protect\hyperref[TreasurerDef]{Treasurer},}
...
\end{enumerate}
The chairs for the \add[S]{Exectutive Committees }\remove[S]{\protect\hyperref[AACdef]{Academic} and \protect\hyperref[CACdef]{Campus Affairs Committee}} are \add[S]{approved}\remove[S]{elected} with a simple majority within the \hyperref[USGParliamentDef]{USG Parliament}.
...
\begin{enumerate}
\item \remove[S]{preside over meetings of the \protect\hyperref[USGParliamentDef]{USG Parliament},
