\remove[RS]{
\protect\add[S]{Throughout the document the following markups are used to denote changes:\\}
\protect\add[P]{Parliament approved additions.\\}
\protect\add[S]{Suggested additions.\\}
\protect\note[N]{Notes.}
\protect\annote[Colin]{\\this text}{is annotated}
\protect\remove[RP]{\\Parliament approved removals.\\}
\protect\remove[RS]{Suggested removals.\\}
\protect\change[S]{original}{suggested replacements}}
\begin{center}
\textbf{Preamble}
\end{center}
