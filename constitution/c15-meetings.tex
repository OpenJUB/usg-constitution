...
\add[S]{The provisions in this article exclusively apply to \change[S]{?}{Parliament meetings. }.}
...
\remove[S]{\item The whole USG \remove[S]{(Parliament and Executive Unit) }has to be informed of any intention for external communication.}\note[Colin]{This is bullshit.}
