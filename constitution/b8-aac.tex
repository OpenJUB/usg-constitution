...
\protect\begin{enumerate}
\item \add[P]{give feedback about academic matters to faculty, administration and the respective }\add[S]{university}\add[P]{Committees (}\add[S]{primarily the }\remove[RS]{Quality Management}\add[S]{University Committee on Quality Management}\add[P]{, }\remove[S]{University Education Committee/Education Advisory Panel}\add[S]{University Committee on Education}),\add[P]{
...
\protect\item represent the \protect\hyperref[studentbody]{USB}'s concerns and opinions in any relevant internal discussions,}\add[N]{\\Colin: That sounds rather questionable, I would rather propose: }\add[S]{
