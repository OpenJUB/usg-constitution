...
\protect\begin{enumerate}
    ...
    \protect\item Hiring Committees Ombudsperson}\add[N]{Personally, I don't like this idea, maybe this question should be left to the AAC (e.g. their RoPs) - Colin}\add[P]{
...
\protect\begin{enumerate}
\item \add[P]{give feedback about academic matters to faculty, administration and the respective }\add[S]{university}\add[P]{committees (}\add[S]{primarily the }\remove[S]{Quality Management}\add[S]{University Committee on Quality Management}\add[P]{, }\remove[S]{University Education Committee/Education Advisory Panel}\add[S]{University Committee on Education}),\add[P]{
...
\protect\item represent the \protect\hyperref[studentbody]{USB}'s concerns and opinions in any relevant internal discussions,}\add[N]{\\That sounds rather questionable -- Colin}\add[S]{
\protect\item represent the USB's interest in the university committees}\add[P]{
...
\add[S]{By default the}\remove[S]{The} AAC chair shall become the undergraduate student representative and a member to the UEC for the respective academic year. \remove[S]{The chair shall attend all UEC meetings. It is at the discretion of the chair to invite additional members of the AAC to attend UEC meetings.}