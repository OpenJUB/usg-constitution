...
\protect\begin{enumerate}
    ...
    \protect\item Hiring Committees Ombudsperson}\add[N]{Personally, I don't like this idea, maybe this question should be left to the AAC (e.g. in their RoPs) - Colin}\add[P]{
...
In order to better represents the interest of students from all major on campus, the AAC selects major representatives of undergraduate study programs. Ideally, there should be one to two major representatives for each major to support inform about and advise the AAC on issues and tasks relevant specifically to their major.
Major representatives don't need to be AAC members.
}
...
\protect\begin{enumerate}
\item \add[P]{give feedback about academic matters to faculty, administration and the respective }\add[S]{university}\add[P]{committees (Quality Management, University Education Committee/Education Advisory Panel),
