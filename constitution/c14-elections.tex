...
\begin{parenum}
\item \add[S]{Only students that have been USG members in a previous semester are elibible to run for an office in the USG. In case of membership in committees, active membership is required.}
\item
...
\item 
Only in exceptional cases, as decided by the \hyperref[USGParliamentDef]{USG Parliament}, one student is allowed to be the Undergraduate Student Representatives of more than one official committees of Jacobs University with student representatives (USR).\add[N]{\\Maybe restrict chairs from being members of too many committees instead. Given the high number of USRs and substitutes, this might otherwise bee too restrictive.}
