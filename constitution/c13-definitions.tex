...
\label{MemberUSGDef}
\add[P]{All members of the \protect\hyperref[USGParliamentDef]{USG Parliament}, all members of the \protect\hyperref[USGexecutiveUnitDef]{USG Executive Unit}}\add[S]{, all university committee members, all major-representatives}\add[P]{ and all Secretaries or members of Support Structures are Members of the USG.}
