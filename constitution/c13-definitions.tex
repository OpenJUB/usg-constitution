...
\label{USRdef}
The Undergraduate Student Representative\add[S]{s}\note[Colin]{(in case of the UCE)} (USR) \add[S]{of a university committee }\change[S]{is}{are} the \change[S]{person physically participating at the University meeting}{undergraduate student representative(s) of that university committee}, as stipulated by the Jacobs University Constitution\add[S]{ and the Rules of Procedure of the respective university committee}.\add[S]{ Usually, each USD also has a substitute replacing them, whenever they cannot attend a meeting.}\note[Colin]{The previous definition is inconsistent with the definition of student representatives in the Rules of Procedures of at least the AS, UCE, UC-QM and UC-AI. }
