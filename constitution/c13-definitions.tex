...
\label{MemberUSGDef}
\add[P]{All members of the \protect\hyperref[USGParliamentDef]{USG Parliament}\add[S]{ and} all members of the \protect\hyperref[USGexecutiveUnitDef]{USG Executive Unit}}}\remove[P]{ and all Secretaries or members of Support Structures are Members of the USG.}\add[S]{ are USG members. Additionally, all major-representatives, all secretaries and all members of supporting structures are adjunct USG members. For the purpose of the constitution, they are not regarded as USG members, unless specified otherwise.}
