...
\begin{parenum}
	...
	\begin{enumerate}
		...
		\remove[S]{\protect\item the candidates receive the second highest number of votes in an election where two positions are to be filled,
		\protect\item the candidates receive the second highest number of votes in an election where any Member of Parliament runs and is elected for a different position within the Parliament,}\note[Colin]{I don't understand these items: If somebody can explain it to me, I might reconsider.}
