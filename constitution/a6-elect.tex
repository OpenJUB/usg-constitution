...
\add[S]{\protect\section{Candidates Eligibility}\protect\label{eligible}
...
\add[S]{
	...
	For the election of the Members of Parliament, each student may distribute three (3) votes on candidates. Afterwards, the Members of Parliament are selected based on the outcome of the election as follows:  
...
\begin{parenum}
	...
	\begin{enumerate}
		...
		\remove[S]{\protect\annote[Colin]{\protect\item the candidates receive the second highest number of votes in an election where two positions are to be filled,
		\protect\item the candidates receive the second highest number of votes in an election where any Member of Parliament runs and is elected for a different position within the Parliament,}{I don't understand these items: If somebody can explain it to me, I might reconsider.}}
