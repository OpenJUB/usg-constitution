...
\begin{parenum}
\item \hyperref[PartA]{Part A} of this document\add[S]{ and the articles \ref{art:judicative} and \ref{art:final}} \change[S]{is}{form} the explicit Constitution, that has to be amended according to Article \ref{art:final}, Section \ref{Ammendments}.
