...
\begin{parenum}
\item \hyperref[PartA]{Part A} of this document\add[S]{ and the articles \protect\ref{art:judicative} and \protect\ref{art:final}} \change[S]{is}{form} the explicit Constitution, that has to be amended according to Article \protect\ref{art:final}, Section \protect\ref{Ammendments}.
\item \add[S]{\protect\hyperref[PartB]{Part B} represents By-Laws and secondary provisions, that can be changed internally by the \protect\hyperref[USGParliamentDef]{USG Parliament} according to Article \protect\ref{art:final}, Section \protect\ref{sec:internal-changes}}
...
\sectionstar{Internal Changes and Amendments of By-Laws}\label{sec:internal-changes}
\begin{parenum}
