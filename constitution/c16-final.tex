...
\begin{parenum}
\item \hyperref[PartA]{Part A} of this document\add[S]{ and the articles \protect\ref{art:judicative} and \protect\ref{art:final}} \change[S]{is}{form} the \remove[S]{explicit }Constitution, \change[S]{that}{which} has to be amended according to Article \protect\ref{art:final}, Section \protect\ref{Ammendments}.
...
\vfill
\nolinenumbers
\emph{Version \change[S]{1.1}{2.0} of this constitution is proposed for amendment. This document has been last edited on \today.}\\
